...
public class Map implements Ball.OnMoveListener {
    ...
    public Map(int w, int h, int bs, LabyrinthView.Callback cb) {
        blockSize = bs;
    ...
    private void createMap() {
        ...
        LabyrinthGenerator.MapResult map = LabyrinthGenerator.getMap(255, horizontalBlockNum, verticalBlockNum);
